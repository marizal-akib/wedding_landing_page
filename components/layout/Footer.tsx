import { footer, WA_AVAILABILITY } from "@/lib/content/weddingLanding";
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="font-sans text-sm text-ivory/60 hover:text-ivory transition-colors duration-200 flex items-center gap-2"
            >

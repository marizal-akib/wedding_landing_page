    ...
    <footer className="bg-warm-dark border-t border-white/5">
      <div className="mx-auto max-w-6xl px-6 md:px-10 py-16 md:py-20">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="font-sans text-sm text-ivory/60 hover:text-ivory transition-colors duration-200 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-amber focus:ring-offset-2 focus:ring-offset-warm-dark rounded"
            >
        ...
        <div className="mt-14 pt-6 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="font-sans text-xs text-ivory/30">{footer.legal}</p>
